#!/usr/bin/env python3
"""Apply wave-3 bitmap-closed ID-command lines to sheet and current-main ROM."""
...
BATCH_ID = "bitmap-wave3-20260907"
KO_MAP = ROOT / "analysis" / "ggen_advance_8x16_bitmap_wave3_ko_20260907.json"
SNAPSHOT = ROOT / "analysis" / "ggen_advance_translation_merged_20260907_bitmap_wave3.json"
OUT_DIR = ROOT / "outputs" / "20260907_ggen_advance_bitmap_wave3"
OUTPUT = OUT_DIR / "ggen_advance_bitmap_wave3_candidate_20260907.gba"
OUT_SAV = OUT_DIR / "ggen_advance_bitmap_wave3_candidate_20260907.sav"
MAIN_SAV = ROOT / "SD Gundam GGeneration Advance (Korean).sav"
REPORT = ROOT / "analysis" / "ggen_advance_bitmap_wave3_candidate_20260907.json"
MANIFEST = OUT_DIR / "manifest.json"
CAVE_START = 0x012B1490
CAVE_END = 0x012C0000
...
def main() -> int:
    ...
    gate(all(value == 0 for value in current[CAVE_START:CAVE_END]), "wave3 cave is not zero-filled")
    ...
    for row in merged["records"]:
        ...
        if korean is None:
            ...
            continue
        jobs.append({"row": row, "source": decoded, "korean": korean, "notes": "8x16 비트맵 wave3 ID커맨드"})
    ...
    for job in jobs:
        ...
        if key in written:
            ...
            gate(end <= CAVE_END, "wave3 cave overflow")
    ...
    identity["bitmap_wave3_batch_identity_sha256"] = new_identity
    ...
    merged["bitmap_wave3_batch_20260907"] = {
        "batch_id": BATCH_ID,
